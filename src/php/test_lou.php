...
$test = Database::instance()->insert("Player", array("Login"=>"KASS4", "mail"=>"gmalalaletetet"));
echo "<pre>".var_export($test, true)."</pre>";
$test = Database::instance()->update("Player", array("mail"=>"unvraimail@lol.com"), array("Login"=>"KASS4"));
echo "<pre>".var_export($test, true)."</pre>";
$test = Database::instance()->delete("PLayer", array("Login"=>"KASS3"));

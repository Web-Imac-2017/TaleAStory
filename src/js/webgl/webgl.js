...
let webGL={
	...
	Background_Animation: function(r,v,b,a){
		...
		this.load = function(){
			...
			sounds = [new Audio(config.soundPath('wind_chime1.mp3')),new Audio(config.soundPath('wind_chime2.mp3')),new Audio(config.soundPath('wind_chime3.mp3')),new Audio(config.soundPath('wind_chime4.mp3')),new Audio(config.soundPath('wind_chime5.mp3')),new Audio(config.soundPath('wind_chime6.mp3')),new Audio(config.soundPath('chirp_1.mp3')),new Audio(config.soundPath('chirp_2.mp3')),new Audio(config.soundPath('chirp_3.mp3')),new Audio(config.soundPath('chirp_4.mp3')),new Audio(config.soundPath('corbeau.wav')),new Audio(config.soundPath('Crickets_1.wav')),new Audio(config.soundPath('Crickets_2.wav')),new Audio(config.soundPath('perroquet1.wav')),new Audio(config.soundPath('rain_1.wav')),new Audio(config.soundPath('sauterelle_2.wav')),new Audio(config.soundPath('sauterelle_3.wav')),new Audio(config.soundPath('sf_hirondelle_02.mp3')),new Audio(config.soundPath('sf_perroquet2.wav')),new Audio(config.soundPath('sf-oiseau-inseparable-01.wav')),new Audio(config.soundPath('sf-picvert-cri-02.mp3')),new Audio(config.soundPath('vent.wav')),new Audio(config.soundPath('vent_fadeout.wav')),new Audio(config.soundPath('Wolf_1.wav')),new Audio(config.soundPath('Wolf_2.wav')),new Audio(config.soundPath('wolf_3.wav'))];
